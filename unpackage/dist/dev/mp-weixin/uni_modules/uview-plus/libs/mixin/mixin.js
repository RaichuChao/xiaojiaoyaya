...
const uni_modules_uviewPlus_libs_theme_runtime = require("../theme/runtime.js");
const mixin = uni_modules_uviewPlus_libs_vue.defineMixin({
  ...
  computed: {
    ...
    $u() {
      this.upThemeVersion;
      let mergeU = uni_modules_uviewPlus_libs_function_index.deepMerge(common_vendor.index.$u, {
        props: void 0,
        http: void 0,
        mixin: void 0
      });
    ...
    upThemeIsDark() {
      this.upThemeVersion;
      return uni_modules_uviewPlus_libs_theme_runtime.getThemeIsDark(this.$u);
    },
    upThemeVars() {
      this.upThemeVersion;
      return uni_modules_uviewPlus_libs_theme_runtime.getThemeVarsForStyle(this.$u);
    },
    upThemePageStyle() {
      this.upThemeVersion;
      return uni_modules_uviewPlus_libs_theme_runtime.getThemePageStyle(this.$u);
    },
    upThemeCardStyle() {
      this.upThemeVersion;
      return uni_modules_uviewPlus_libs_theme_runtime.getThemeCardStyle(this.$u);
    },
    /**
     * 生成bem规则类名
  ...
  methods: {
    ...
    upThemeVar(varName, fallbackColor) {
      this.upThemeVersion;
      return uni_modules_uviewPlus_libs_theme_runtime.getThemeVar(varName, fallbackColor, this.$u);
    },
    upApplyNativeThemeUI() {
      uni_modules_uviewPlus_libs_theme_runtime.syncThemeRuntimeFromStorage(this.$u);
      this.upSyncThemeVersion();
      uni_modules_uviewPlus_libs_theme_runtime.applyNativeThemeUIDeferred(this.$u);
    },
    // 跳转某一个页面
    openPage(urlKey = "url") {
