...
const _sfc_main = {
  name: "up-text",
  mixins: [common_vendor.mpMixin, common_vendor.mixin, common_vendor.value, common_vendor.buttonMixin, common_vendor.openType, common_vendor.props$10],
  emits: ["click"],
  computed: {
    wrapStyle() {
      let style = {
    ...
    valueStyle() {
      ...
      if (!this.type) {
        style.color = this.color || this.upThemeVar("--up-content-color", ((_b = (_a = this.$u) == null ? void 0 : _a.color) == null ? void 0 : _b.contentColor) || "#606266");
      }
