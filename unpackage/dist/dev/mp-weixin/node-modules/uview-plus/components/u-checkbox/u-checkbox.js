...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    c: common_vendor.o((...args) => $options.iconClickHandler && $options.iconClickHandler(...args), "24"),
    ...
    k: common_vendor.o((...args) => $options.labelClickHandler && $options.labelClickHandler(...args), "60"),
    l: common_vendor.s($options.checkboxStyle),
    m: common_vendor.o((...args) => $options.wrapperClickHandler && $options.wrapperClickHandler(...args), "6f"),
