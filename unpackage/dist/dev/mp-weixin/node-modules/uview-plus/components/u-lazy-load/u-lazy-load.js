...
const _sfc_main = {
  ...
  data() {
    return {
      ...
      isError: false,
      // 图片加载失败
      elIndex: common_vendor.guid()
    };
  },
  computed: {
    // 将threshold从rpx转为px
    getThreshold() {
      let thresholdPx = common_vendor.rpx2px(Math.abs(this.threshold));
      return this.threshold < 0 ? -thresholdPx : thresholdPx;
    },
    // 计算图片的高度，可能为auto，带%，或者直接数值
    imgHeight() {
      return common_vendor.addUnit(this.height);
    }
  },
  created() {
    this.observer = {};
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-267033c8"]]);
wx.createComponent(Component);
//# sourceMappingURL=../../../../../.sourcemap/mp-weixin/node-modules/uview-plus/components/u-lazy-load/u-lazy-load.js.map
